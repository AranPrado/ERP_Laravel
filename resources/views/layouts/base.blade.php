            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    @if (Auth::user()->is_admin)
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="{{ route('feedstock.index') }}">Materia
                                Prima</a>
                        </li>
                    @endif
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="{{ route('cart') }}">
                                ...
                                <span id="notificationBadge"
                                    class="position-absolute top-10 end-10 translate-middle badge bg-danger rounded-circle">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item"
                                    href="{{ route('users.update', ['id' => Auth::user()->id]) }}">Perfil</a></li>
                            <li>
